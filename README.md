...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-27 15:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/01043328-1477-4b01-a59a-814837bced2d.git
$ cd 01043328-1477-4b01-a59a-814837bced2d
```
